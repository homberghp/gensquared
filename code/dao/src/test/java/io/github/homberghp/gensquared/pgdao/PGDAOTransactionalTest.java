...
public class PGDAOTransactionalTest extends PGDAOTestBase {
    ...
    public void testNullableFields() {
        ...
        cdao.deleteAll( c );
        assertSoftly( softly -> {
            assertThat( sC.ticker() ).isEqualTo( tick );
            assertThat( sC.name() ).as( "name is null" ).isNull();
            assertThat( sC.i() ).as( "someint" ).isEqualTo( 0 );
            assertThat( sC.j() ).as( "someinteger" ).isEqualTo(
                    null );
        } );
